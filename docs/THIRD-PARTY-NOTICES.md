...
the project lives point at Osade's repository; release, download and history addresses are kept
unchanged, and the release manifests are trimmed to the pinned release. `backend/OSADE-PIN.json` records the
